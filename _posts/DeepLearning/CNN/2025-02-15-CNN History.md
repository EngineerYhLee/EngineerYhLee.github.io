...
CNN은 여러 시대의 혁신적인 연구들을 통해 발전해왔습니다. 아래는 시대별 타임라인 형태로 정리한 내용입니다.
...
![Hubel & Wiesel]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/01_hubel_wissel_cat.png)
...
![Neocognitron]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/02_Neocognitron.png)
...
- **역전파 도입**  
  ...
  ![Neocognitron]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/03_Backpropagation.png)
...
![AlexNet]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/05_AlexNet.png)
...
![VGGNet]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/06_VGGNet.png)
...
![GoogLeNet]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/07_GoogLeNet.png)
...
![ResNet]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/08_ResNet.png)
...
![EfficientNet]({{ site.url }}{{ site.baseurl }}/assets/images/2025-02-15-CNN History/09_EfficientNet.png)
